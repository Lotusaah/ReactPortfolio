...
import Clamptop from './3D-files/clamp-top-v2.gltf'; // Import the GLTF file

export const ClampTop: React.FC = () => {
  ...
  useEffect(() => {
    ...
    console.log('Loading GLTF from:', Clamptop);

    loader.load(
      Clamptop,
      function (gltf) {
        const model = gltf.scene;
        model.scale.set(300, 300, 300); // Adjust the scale if necessary
